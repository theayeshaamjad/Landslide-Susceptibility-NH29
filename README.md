...
| :--- | :--- | :--- | :--- | :--- |
| 1 | Slope | 0.211 | 21.1% | Primary driver of shear stress and gravitational force[cite: 5, 10]. |
| 2 | Rainfall | 0.168 | 16.8% | Dynamic temporal trigger that increases pore-water pressure[cite: 5, 10]. |
| 3 | LULC | 0.126 | 12.6% | Influences surface stability and root cohesion[cite: 5, 10]. |
| 4 | TWI | 0.098 | 9.8% | Identifies zones of potential soil saturation[cite: 5, 10]. |
| 5 | Dist. to Streams | 0.079 | 7.9% | Accounts for basal support removal via toe-erosion[cite: 5, 10]. |
| 6 | Dist. to Roads | 0.063 | 6.3% | Anthropogenic mechanical slope modification[cite: 5, 10]. |
| 7 | Elevation | 0.052 | 5.2% | Influences climatic regime[cite: 5, 10]. |
| 8 | Aspect | 0.051 | 5.1% | Affects soil moisture and solar exposure[cite: 5, 6]. |
| 9 | Soil Type | 0.044 | 4.4% | Determines drainage and shear strength[cite: 5, 11]. |
| 10 | Curvature | 0.042 | 4.2% | Affects flow acceleration and convergence[cite: 5, 6]. |
| 11 | NDVI | 0.036 | 3.6% | Secondary modifier reflecting surface condition[cite: 5, 10]. |
| 12 | Drainage Density | 0.030 | 3.0% | Represents runoff concentration potential[cite: 5, 10]. |
...
The reclassified layers were integrated in ArcMap using the Raster Calculator, applying the normalized AHP weights to generate the final contiguous susceptibility surface[cite: 11].# Landslide-Susceptibility-NH29
